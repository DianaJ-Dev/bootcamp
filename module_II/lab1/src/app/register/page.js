...
export default function Register () {
    ...
    <h4 className="text-center text-3xl  text-white mb-10 p-8">Ingresar datos de registro </h4>    
    ...
    <FloatingLabel controlId="floatingPassword" label="Ingresa Contraseña" className="mb-3">
        ...
        <Button variant="primary" type="submit" className="bg-aliceblue text-blue  mx-40 mb-10">Enviar</Button>
